//
//  OptionsToFindPasswordViewController.swift
//  LeanOnMe
//
...
class OptionsToFindPasswordViewController: UIViewController {
    ...
    @objc func HandleWithPhonenumber() {
        let findPasswordWithPhoneNumberViewController = FindPasswordWithPhoneNumberViewController()
        navigationController?.pushViewController(findPasswordWithPhoneNumberViewController, animated: true)
    }
    
    @objc func HandleWithEmail() {
        
        let findPasswordWithEmailViewController = FindPasswordWithEmailViewController()
        navigationController?.pushViewController(findPasswordWithEmailViewController, animated: true)
    }
