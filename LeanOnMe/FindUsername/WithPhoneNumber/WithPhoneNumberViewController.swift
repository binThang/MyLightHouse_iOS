//
//  FindUsernameViewController.swift
//  LeanOnMe
//
...
class WithPhoneNumberViewController: UIViewController {
    ...
    lazy var phoneNumberTextfield: UITextField = {
        ...
        textfield.font = notoSansUIRegular(14)
        textfield.keyboardType = .numberPad
        textfield.attributedPlaceholder = NSAttributedString(string: "번호를 입력해 주세요.", attributes: [NSAttributedStringKey.foregroundColor: UIColor.init(hexString: "#131215").withAlphaComponent(0.3), NSAttributedStringKey.font: notoSansUIRegular(14)])
        let paddingView = UIView(frame: CGRect(x: 0, y: 0, width: 10, height: 30))
        textfield.leftView = paddingView
        textfield.leftViewMode = .always
        textfield.translatesAutoresizingMaskIntoConstraints = false
