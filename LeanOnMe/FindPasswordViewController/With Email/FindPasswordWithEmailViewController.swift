//
//  FindPasswordWithEmailViewController.swift
//  LeanOnMe
//
...
class FindPasswordWithEmailViewController: UIViewController {
    ...
    let usernameTextfield: UITextField = {
        ...
        textfield.attributedPlaceholder = NSAttributedString(string: "아이디를 입력해 주세요.", attributes: [NSAttributedStringKey.foregroundColor: UIColor.init(hexString: "#131215").withAlphaComponent(0.3), NSAttributedStringKey.font: komaconFont(14)])
